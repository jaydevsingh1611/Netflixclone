...
//Inngest Function to Update user from a  database
...
const releaseSeatsAndDeleteBooking = inngest.createFunction(
    ...
    async ({ event, step }) => {
        ...
        await step.sleepUntil('wait-for-10-minutes', later);
...
const sendShowRemainders = inngest.createFunction(
    ...
    <p>It is a quick reminder that your movie:</p>
    ...
    <p>Enjoy the show!<br/>- netShow Team</p>
    </div>`
                }))
            )
        })
